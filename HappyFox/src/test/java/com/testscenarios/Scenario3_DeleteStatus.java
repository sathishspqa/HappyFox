...
public class Scenario3_DeleteStatus {
	...
	public void beforeClass() throws Exception {
       ...
       ExtentSparkReporter ESR = new ExtentSparkReporter("C:\\Users\\Light\\eclipse-workspace\\HappyFox\\Reports\\DeleteStatus.html");
	...
	public void f() throws Exception {
		...
		ExtentTest test = er.createTest("Delete Status").assignAuthor("SathishSp").assignCategory("Functional Testing").assignDevice("Windows");
		...
		Thread.sleep(5000);
			...
			test.info("Click Statuses Title"); 
			...
			driver.findElement(By.xpath("//a[@class='hf-delete-item hf-u-push-right hf-js-delete-status-trigger']")).click();
			
			Thread.sleep(7000);
			
		 			
			
		 test.info("Delete Status");
	      ...
	      WebElement ModElement = ModContainer.findElement(By.xpath("//span[normalize-space()='Choose Status']"));
	       
	      ModElement.click();
	      
	      Thread.sleep(2000);
	      
	      WebElement completed = ModContainer.findElement(By.xpath("//li[normalize-space()='Completed']"));
